...
{
  cloud_msgs__msg__CloudInfo * msg = (cloud_msgs__msg__CloudInfo *)malloc(sizeof(cloud_msgs__msg__CloudInfo));
  if (!msg) {
    return NULL;
  }
...
cloud_msgs__msg__CloudInfo__Sequence__init(cloud_msgs__msg__CloudInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (cloud_msgs__msg__CloudInfo *)calloc(size, sizeof(cloud_msgs__msg__CloudInfo));
    if (!data) {
      return false;
    }
...
{
  cloud_msgs__msg__CloudInfo__Sequence * array = (cloud_msgs__msg__CloudInfo__Sequence *)malloc(sizeof(cloud_msgs__msg__CloudInfo__Sequence));
  if (!array) {
    return NULL;
  }
